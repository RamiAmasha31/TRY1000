  ...
  return (
    <section className="bg-black text-white py-24 px-4 flex flex-col items-center justify-center">
      <div className="container mx-auto text-center flex flex-col items-center">
        <h2 className="text-5xl font-bold text-[#00df9a] mb-4">Location and Hours</h2>
        {/* Display map */}
        ...
        {/* Operating Hours */}
        <div className="mb-12">
          <h3 className="text-5xl font-bold text-[#00df9a] mb-4">Operating Hours</h3>
          <p className="text-lg">Monday - Friday: 9:00 AM - 10:00 PM</p>
          <p className="text-lg">Saturday - Sunday: 10:00 AM - 11:00 PM</p>
        </div>
        {/* Additional information */}
        <div className="mb-12">
          <h3 className="text-5xl font-bold text-[#00df9a] mb-4">Parking Information</h3>
          <p className="text-lg">Free parking available in the rear</p>
        </div>
        {/* Directions */}
        <div>
          <h3 className="text-5xl font-bold text-[#00df9a] mb-4">Directions</h3>
